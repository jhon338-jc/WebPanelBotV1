...
import webMemberRoutes from './web/member.js'
import webPremiumRoutes from './web/premium.js'
import webLanggananRoutes from './web/langganan.js'
...
router.use('/member', webMemberRoutes)
router.use('/premium', webPremiumRoutes)
router.use('/langganan', webLanggananRoutes)
